        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            var config = new AutoMapper.MapperConfiguration(cfg =>
            {
                cfg.CreateMap<Plan, PlanStatusVM>()
                    ...
                    .ForMember(dest => dest.StatusColor, m => m.MapFrom(src => src.Result == null ? "#70bfe4" : src.Result.Status == StatusType.Complete ? "#63c163" : src.Result.Status == StatusType.Failed ? "#f7505a" : "#70bfe4"))
                ...
                //.ForMember(dest => dest.Actions, m => m.MapFrom(src => src.HasActionGroup ? new List<ActionItem> { src.ActionGroup } : new List<ActionItem>()))
                //.ForMember(dest => dest.IsActionGroup, m => MapFrom(src => src.HasActionGroup));
            });
